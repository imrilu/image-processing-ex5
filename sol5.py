...
denoise_model.load_weights("C:\/Users\Imri\PycharmProjects\IP_ex5\ex5-imrilu\imri_final_denoise")

# deblur_model = learn_deblurring_model()
deblur_model.load_weights("C:\/Users\Imri\PycharmProjects\IP_ex5\ex5-imrilu\imri_final_deblur")
...
# showing corrupted image
plt.imshow(im_corrupt, cmap='gray')
plt.show()

after = restore_image(im_corrupt, deblur_model)
...
# val_error_deblur = []
# for i in range(5, 6):
#     denoise_model = build_nn_model(24, 24, 48, i)
#     denoise_model.load_weights("C:\/Users\Imri\PycharmProjects\IP_ex5\ex5-imrilu\imri_final_denoise")
#     history = denoise_model.history
#     val_error_denoising.append(
#         history.history['val_loss'][len(history.history['val_loss']) - 1])
# for i in range(1, 6):
#     deblur_model = build_nn_model(16, 16, 32, i)
#     deblur_model.load_weights("C:\/Users\Imri\PycharmProjects\IP_ex5\ex5-imrilu\imri_final_deblur")
#     history = deblur_model.history
#     val_error_deblur.append(
#         history.history['val_loss'][len(history.history['val_loss']) - 1])
# plt.plot([1, 2, 3, 4, 5], val_error_denoising)
# plt.savefig("depth_plot_denoise.png")
# plt.close()
# plt.plot([1, 2, 3, 4, 5], val_error_deblur)
...
# val_error_deblur = []
# for i in range(1, 6):
#     model = learn_denoising_model(i)
#     history = model.history
#     val_error_denoising.append(
#         history.history['val_loss'][len(history.history['val_loss']) - 1])
# for i in range(1, 6):
#     model = learn_deblurring_model(i)
#     history = model.history
#     val_error_deblur.append(
#         history.history['val_loss'][len(history.history['val_loss']) - 1])
# plt.plot([1, 2, 3, 4, 5], val_error_denoising)
